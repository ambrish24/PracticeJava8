...
public class HashMapSorting{
    ...
    public static void main(String args[]) {
        ...
        Comparator<Map.Entry<String, String>> valueComparator = new
        ...
        List<Map.Entry<String, String>> listOfEntries = new ArrayList<Map.Entry<String,
                String>>(entries);
