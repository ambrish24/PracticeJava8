...
*/
        ...
        // TODO : Example Streams can be traversed only once

        List<String> nameList2 = studentStream.map(Student::getName) //<Stream<String>>
                .peek(System.out::println)
                .distinct() // removes duplicates
                .collect(Collectors.toList());

        System.out.println("namesList  : " + nameList2);

        // TODO : Exception in thread "main" java.lang.IllegalStateException: stream has already been operated upon or closed

        List<String> nameList3 = studentStream.map(Student::getName) //<Stream<String>>
                .peek(System.out::println)
                .distinct() // removes duplicates
                .collect(Collectors.toList());

        System.out.println("namesList  : " + nameList3);
