...
public class StudentDataBase {
    ...
    /**
     * Total of 8 students in the database.
     * @return
     */
    public static List<Student> getAllStudents(){
         ...
         * 1st grade students
         */
        Student student7 = new Student("Ram",1,4.8, "male",11,Arrays.asList("cricket", "tennis","badminton"));
        Student student8 = new Student("Sita",1,4.8,"female", 15,Arrays.asList("gymnastics", "cricket","soccer"));
